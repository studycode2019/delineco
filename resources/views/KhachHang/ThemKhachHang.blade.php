...
<div class="row">
    <div class="col-md-4 offset-4">
        <div class="card card-primary">
            ...
            <form role="form" action="/home/postthemkhachhang" method="post">
                {{ csrf_field() }}
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="gioiTinh" value="Nu">Nữ
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Chứng minh nhân dân/Căn cước</label>
                        <input type="text" class="form-control" name="CMND" placeholder="312350836">
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-2">
